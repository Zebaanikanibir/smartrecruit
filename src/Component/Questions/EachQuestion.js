    ...
    return (
        <div>
            ...
            <div className="line">
                ...
                <svg onClick={() =>setReportPopUp(true)}   style={{ width: '30px', color: 'rgb(236, 108, 108)' }} xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
