...
<div className="menu">
<svg onClick={() => setPopUp(true)} style={{ width: '30px', color: '#3A72B7', textAlign:'end',marginLeft:'50px'}}  xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
